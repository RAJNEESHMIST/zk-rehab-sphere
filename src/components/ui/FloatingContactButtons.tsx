...
export const FloatingContactButtons: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col gap-3 items-end pointer-events-auto">
      
      {/* Interactive Call Icon Button */}
      <div className="relative group flex items-center">
        {/* Hover Tooltip Label (Shows interactively on hover) */}
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.9 }}
          aria-label="Call ZK Rehab Sphere"
          className="w-14 h-14 rounded-full bg-gradient-to-r from-cyan-400 to-sky-400 text-slate-950 flex items-center justify-center shadow-[0_0_20px_rgba(6,182,212,0.6)] hover:shadow-[0_0_30px_rgba(6,182,212,0.9)] transition-all border border-cyan-200/50"
        >
          <Phone size={22} className="animate-pulse" />
        </motion.a>
      </div>

      {/* Interactive WhatsApp Icon Button */}
      <div className="relative group flex items-center">
        {/* Hover Tooltip Label (Shows interactively on hover) */}

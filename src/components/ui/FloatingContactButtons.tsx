      ...
      <div className="hidden md:flex fixed bottom-6 right-6 z-[9999] flex-col gap-3 items-end pointer-events-auto">
        ...
        <div className="relative group flex items-center">
          ...
          <button
            ...
            className="ripple-wave-cyan w-14 h-14 rounded-full bg-gradient-to-r from-cyan-400 to-sky-400 text-slate-950 flex items-center justify-center shadow-[0_0_20px_rgba(6,182,212,0.6)] hover:shadow-[0_0_30px_rgba(6,182,212,0.9)] transition-all border border-cyan-200/50 cursor-pointer"
          >
        ...
        <div className="relative group flex items-center">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="ripple-wave-emerald relative w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20ba5a] text-white flex items-center justify-center shadow-[0_0_20px_rgba(37,211,102,0.6)] hover:shadow-[0_0_30px_rgba(37,211,102,0.9)] transition-all border border-emerald-200/40"
          >

...
import { Calendar, User, ArrowLeft, Loader2, Share2, Eye, MessageCircle, Globe } from 'lucide-react';
          ...
          <div className="md:grid md:grid-cols-[64px_1fr] gap-12">
            <div className="md:block hidden sticky top-28 h-fit">
              <div className="flex flex-col gap-4">
                <button className="w-12 h-12 rounded-full bg-slate-50 text-slate-400 flex items-center justify-center hover:bg-primary hover:text-white transition-all shadow-sm"><Globe size={18} /></button>
                <button className="w-12 h-12 rounded-full bg-slate-50 text-slate-400 flex items-center justify-center hover:bg-primary hover:text-white transition-all shadow-sm"><Share2 size={18} /></button>
                <button className="w-12 h-12 rounded-full bg-slate-50 text-slate-400 flex items-center justify-center hover:bg-primary hover:text-white transition-all shadow-sm"><Globe size={18} /></button>
              </div>
            </div>

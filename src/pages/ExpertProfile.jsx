            ...
            <div className="space-y-4">
              ...
              {expert.socialLinks && Object.values(expert.socialLinks).some(v => v) && (
                <div className="flex justify-center gap-4 py-2">
                  {expert.socialLinks.linkedin && <a href={expert.socialLinks.linkedin} className="p-3 bg-slate-50 text-slate-400 hover:text-blue-600 rounded-full transition-colors"><Globe size={18} /></a>}
                  {expert.socialLinks.twitter && <a href={expert.socialLinks.twitter} className="p-3 bg-slate-50 text-slate-400 hover:text-blue-400 rounded-full transition-colors"><Globe size={18} /></a>}
                  {expert.socialLinks.facebook && <a href={expert.socialLinks.facebook} className="p-3 bg-slate-50 text-slate-400 hover:text-blue-700 rounded-full transition-colors"><Globe size={18} /></a>}
                </div>
              )}
            </div>
          </div>

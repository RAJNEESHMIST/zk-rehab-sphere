...
export const initialExperts: Expert[] = [
  {
    ...
    qualification: "BPT, Certified Orthopaedic Rehabilitation Specialist",
    experienceYears: 6,
    rating: 4.8,
    reviewsCount: 98,
    specializations: ["Orthopaedic Rehabilitation", "Joint Replacement Rehabilitation", "Spine Rehabilitation", "Sports Injury Rehabilitation", "Sciatica & Disc Disorders", "Post-Operative Rehabilitation", "Pain & Mobility Management"],
    biography: "Dr. Numan Ahmed is a dedicated orthopaedic physiotherapy professional focused on helping patients restore movement, strength, mobility, and functional independence. His clinical approach emphasizes detailed assessment, personalized rehabilitation programs, therapeutic exercise, and progressive functional training for patients recovering from orthopaedic conditions, injuries, and surgical procedures. He is particularly focused on structured rehabilitation following joint replacement and musculoskeletal conditions, with an aim to reduce pain, improve physical function, and support a safe and confident return to daily activities. His patient-centred approach combines clinical precision, individualized care, and evidence-informed rehabilitation strategies.",
  ...
  },
  {
    ...
    qualification: "BPT, Specialised in Neuro Rehabilitation",
    experienceYears: 5,
    rating: 4.9,
    reviewsCount: 115,
    specializations: ["Neurological Rehabilitation", "Stroke Rehabilitation", "Spinal Cord Rehabilitation", "Balance & Gait Training"],
    biography: "Dr. Mehul Kumar is a dedicated Neuro-Rehabilitation professional with a strong focus on restoring movement, functional independence, and quality of life in individuals living with neurological conditions. His approach combines patient-centred care, structured rehabilitation, functional training, and evidence-informed physiotherapy to develop individualized rehabilitation programs based on each patient’s condition, functional limitations, and recovery goals.",
    availability: "Mon - Sat (By Appointment)",
    location: "Chandigarh & Mohali",
    image: expertMehulImg || expert2Img,
    certifications: ["Neurological Rehabilitation", "Stroke Rehabilitation", "Spinal Cord Rehabilitation", "Balance & Gait Training", "Functional Mobility", "Patient-Centred Rehabilitation"],
    socialLinks: {
      email: "zkrehabsphere@gmail.com"
    }
  },
  {
    id: "exp-4",
    name: "Dr. Mani Bhusan",
    role: "Orthopaedic & Neurological Rehabilitation Specialist",
    qualification: "BPT, MPT (Orthopaedics)",
    experienceYears: 10,
    rating: 4.9,
    reviewsCount: 120,
    specializations: ["Orthopaedic Rehabilitation", "Neurological Rehabilitation", "Musculoskeletal Disorders", "Spine Rehabilitation", "Joint & Sports Injuries", "Post-Operative Rehabilitation", "Balance & Mobility Training"],
    biography: "Dr. Mani Bhusan is an experienced physiotherapy professional with clinical expertise in both orthopaedic and neurological rehabilitation. He works with patients experiencing musculoskeletal conditions, joint and spine problems, sports injuries, post-operative limitations, neurological impairments, and mobility-related challenges. His approach focuses on accurate functional assessment, individualized rehabilitation planning, therapeutic exercise, mobility restoration, and evidence-informed physiotherapy to help patients achieve better movement, independence, and long-term functional outcomes.",
    availability: "Mon - Sat (By Appointment)",
    location: "Chandigarh, Mohali, Kharar",
    image: expertManiImg || expert3Img,
    certifications: ["Orthopaedic Rehab Specialist", "Neurological Rehab Specialist"],
    socialLinks: {
      email: "zkrehabsphere@gmail.com"
    }
  }
